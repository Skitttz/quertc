...
* 💡 **Chat em tempo real** — mensagens instantâneas com atualização automática via WebSocket.
* 🧑‍🤝‍🧑 **Salas públicas e privadas** — entre em grupos abertos ou crie salas protegidas por senha.
...
| ----------------------------- | ---------------------------------------------- |
| **Frontend**                  | Next + React.js + Tailwind CSS                        |
